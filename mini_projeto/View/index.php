...
<body>
    ...
    <form method="POST">
        ...
        <textarea name="observacao" id="observacao" placeholder="Detalhes sobre a OS (máx. 100 caracteres)" maxlength="100"></textarea>
         ...
         <label for="codVeiculo">Veiculo:</label>
        <textarea name="codVeiculo" id="codVeiculo" placeholder="Detalhes sobre a OS (máx. 100 caracteres)" maxlength="100"></textarea>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($os->getCodCliente()); ?></td>
                <td><?php echo htmlspecialchars($os->getCodVeiculo()); ?></td>
